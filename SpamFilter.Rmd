...
```{R Correlation Matrix, fig.align = "center", fig.width=7, fig.height=7}
...
emails.rp = rpart(isSpam ~ ., 
                  ...
                  minbucket = 50)
summary(emails.rp)
fancyRpartPlot(emails.rp, main="Decision Tree Graph")
```
